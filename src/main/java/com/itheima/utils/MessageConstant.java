...
public class MessageConstant {
    public static final String CACHE_CODE_PHONE = "cache:code:";
    ...
    public static final String EDITY_SETMEAL_FAIL = "修改套餐数据失败";
    ...
    public static final String GET_MEMBER_SUCCESS = "获取会员数据成功";
    public static final String GET_MEMBER_FAIL = "获取会员数据失败";
    ...
    public static final String LOGIN_ERROR = "登录失败，请先注册";
    public static final String VALIDATEPHONE_ERROR = "手机号已被注册";
    public static final String VALIDATECODE_ERROR = "手机号或验证码输入错误";
    ...
    public static final String ORDER_ERROR = "预约失败";
